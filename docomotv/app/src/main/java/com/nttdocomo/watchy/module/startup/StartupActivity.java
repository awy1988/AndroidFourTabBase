package com.nttdocomo.watchy.module.startup;
...
import com.nttdocomo.watchy.module.main.MainActivity;
import com.nttdocomo.watchy.util.ScreenUtils;
...
public class StartupActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    void init() {
        ...
        mIvLaunchScreen = findViewById(R.id.iv_launch_screen);
